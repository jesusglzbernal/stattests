...
class KendallRankCorrelation(AbstractTest):

    def __init__(self):
        super().__init__("single")
        self.print_statistic.set_test_name("Kendall's Rank Correlation")
    ...
    def evaluate_statistic(self, data):
        ...
        assert self.print_statistic.number_of_vectors > 1, "This test is for a single array of numbers"
        stat, p = kendalltau(data[0], data[1])
