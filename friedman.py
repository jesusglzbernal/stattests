...
class Friedman(AbstractTest):

    def __init__(self):
        super().__init__("single")
        self.print_statistic.set_test_name("Friedman")
    ...
    def evaluate_statistic(self, data):
        ...
        assert self.print_statistic.number_of_vectors >= 3, "This test if for three or more arrays of numbers"
